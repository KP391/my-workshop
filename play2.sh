...
#Read more about stty at https://unix.stackexchange.com/questions/239808/how-to-display-control-characters-c-d-differently-in-the-shell/243651#243651
...
function LIST_GAME {
  ...
  if [ -z $(cat $LIST_FILE) ]; then
    ...
    echo " Would you like to add new game? (y/n)"
